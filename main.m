...
E=acos((e+cosd(theta1))/(1+e*cosd(theta1)));
M=E-e*sin(E);

%% Part 2: Exit. Geocentric Parking orbit and hyperbolic trajectory and deltaV
a = a*dST;
[r1,v1,theta1] = OrbitalVectors (t1,mu,a,e,i,Omega,w,M,t1);
v_inf1=v1-v1_E;
[hyperbolaExit, deltaV] = outHyperbola (t1,a,e,i,Omega,w,theta1,v1,v1_E,v_inf1)
